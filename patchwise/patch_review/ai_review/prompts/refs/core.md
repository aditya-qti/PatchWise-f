...
- `validator_will_check` is mandatory and must list every structural check
  ...
  resource/rate/power abstraction, unproven helper-replacement postconditions,
  or parent/child compatible-contract mismatches will cause the validator to
  reject the report and force self-repair/re-spawn.
